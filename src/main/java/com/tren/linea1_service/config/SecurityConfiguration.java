    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(GET, "/card/admin/**").hasAnyAuthority(ADMIN_READ.name())
                        .requestMatchers(POST, "/card/admin/**").hasAnyAuthority(ADMIN_CREATE.name())
                        .requestMatchers(PUT, "/card/admin/**").hasAnyAuthority(ADMIN_UPDATE.name())
                        .requestMatchers(DELETE, "/card/admin/**").hasAnyAuthority(ADMIN_DELETE.name())
                        .anyRequest()
                        .authenticated()
                )
